...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *lino_h4ack*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *lino_h4ack*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *lino_h4ack*.`,
